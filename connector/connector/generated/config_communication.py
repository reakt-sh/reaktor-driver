...
COMM_STATUS_MESSAGE_SPACING_TIME = 1000 # Time between two status messages in ms (unless issued otherwise, e.g. forced response or acknowledgement of an heartbeat).
