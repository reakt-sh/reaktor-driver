...
DRIVER_BRAKING_THRESHOLD_RPM = 1000 # Threshold as difference between current and target speed (in RPM) at which the brakes will be engaged to further decelerate.
